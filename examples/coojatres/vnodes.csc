...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>29.769558448047974</x>
        <y>40.40450082721671</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>59.36965374622888</x>
        <y>40.00683567062582</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>29.93828926430082</x>
        <y>22.52584348952909</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
      ...
      <interface_config>
        ...
        <history>7~;5~;h~;5~;h~;6~;h~;k~;f~;k~;g~;f~;g~;h~;d~;</history>
      </interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.3578972881130476 0.0 0.0 5.3578972881130476 -4.7006684715007925 -61.41842847227963</viewport>
    </plugin_config>
    <width>400</width>
    <z>6</z>
    <height>400</height>
