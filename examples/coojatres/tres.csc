...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>20.549090397664706</x>
        <y>40.381025445922056</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>27.727672934096756</x>
        <y>40.60868937861183</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>33.73437704053118</x>
        <y>35.488220304274286</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>12.186383531292577 0.0 0.0 12.186383531292577 -166.70005680514362 -347.07306347089104</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
