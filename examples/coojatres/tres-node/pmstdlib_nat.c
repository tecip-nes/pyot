...
/* From: /home/andrea/mygitbucket/contiki-tres/apps/tres/tres_pymite.py */
#include <tres-pymite.h>

/* From: /home/andrea/mygitbucket/contiki-tres/apps/pymite/lib/string.py */
#include <stdlib.h>
#include <string.h>
...
PmReturn_t
nat_06_tres_pymite__getState(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_07_tres_pymite_saveState(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_08_tres_pymite_pop(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_09_tres_pymite_push(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_10_list_append(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_11_list_index(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_12_list_insert(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_13_list_pop(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_14_list_remove(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_19___bi_chr(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_20___bi_dir(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_21___bi_eval(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_22___bi_globals(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_23___bi_id(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_24___bi_len(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_25___bi_locals(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_26___bi_ord(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_27___bi_range(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_28___bi_sum(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_29___bi_type(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_30___bi_Co(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_31___bi___init__(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_32___bi_send(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_33___bi_ismain(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_34_sys_exit(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_35_sys_gc(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_36_sys_getb(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_37_sys_heap(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_38_sys_putb(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_39_sys_runInThread(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_40_sys_time(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_41_string_atoi(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_42_string_count(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_43_string_find(pPmFrame_t *ppframe)
{
...
pPmNativeFxn_t const std_nat_fxn_table[] =
{
    ...
    nat_06_tres_pymite__getState,
    nat_07_tres_pymite_saveState,
    nat_08_tres_pymite_pop,
    nat_09_tres_pymite_push,
    nat_10_list_append,
    nat_11_list_index,
    nat_12_list_insert,
    nat_13_list_pop,
