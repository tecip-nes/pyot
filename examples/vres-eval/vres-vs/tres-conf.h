...
#define COAP_MAX_OBSERVERS      0//COAP_MAX_OPEN_TRANSACTIONS-2
#endif

#ifndef COAP_CONF_MAX_OBSERVEES
#define COAP_CONF_MAX_OBSERVEES      4//COAP_MAX_OPEN_TRANSACTIONS-2
#endif

#define TRES_CONF_IS_MAX_NUMBER 4
#define TRES_CONF_OD_MAX_NUMBER 0
