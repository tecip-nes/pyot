...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>17.971210936631223</x>
        <y>85.94425694807484</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>63.85317420915237</x>
        <y>14.528457837456976</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
...
NUM_NODES = 5;&#xD;
CONTROL_NODE = 7;&#xD;
SENSOR_NODE = [3, 4, 5, 15];&#xD;
ACTUATOR_NODE = [10, 11, 12, 14];&#xD;
RUNS = 1000;&#xD;
&#xD;
...
function new_file(str) {&#xD;
    return new FileWriter("vres4x4.txt");&#xD;
}&#xD;
&#xD;
function mylog(str)&#xD;
{&#xD;
...
&#xD;
  ...
  powerlog_started = 0;&#xD;
  file = new_file("");&#xD;
  pl = new FileWriter("pl-vres4x4.txt");&#xD;
  //powerlog_init();&#xD;
  t = "\t";&#xD;
...
&#xD;
  if (id==7 &amp;&amp; msg.indexOf("T: ") != -1 /*&amp;&amp; sensor_id == -1*/) {&#xD;
    ...
    &#xD;
    &#xD;
     if (powerlog_started == 0){&#xD;
     /* start the powerlog */&#xD;
     write(sim.getMoteWithID(13), "p");&#xD;
     write(sim.getMoteWithID(6), "p");&#xD;
     write(sim.getMoteWithID(9), "p");&#xD;
     write(sim.getMoteWithID(10), "p");&#xD;
     write(sim.getMoteWithID(5), "p");&#xD;
     powerlog_started = 1;&#xD;
    }&#xD;
        //script_start_time = -1;&#xD;
    //script_end_time = -1;&#xD;
...
&#xD;
  if (id == ACTUATOR_NODE[0] &amp;&amp; msg.indexOf("A: ") != -1 &amp;&amp; delay == -1) {&#xD;
    ...
    //sensor_id = -1;&#xD;
       ...
       &#xD;
  if (id == ACTUATOR_NODE[3] &amp;&amp; msg.indexOf("A: ") != -1 &amp;&amp; delay == -1) {&#xD;
