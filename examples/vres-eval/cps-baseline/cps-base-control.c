...
#define INPUT_SENSORS     INOUT
#define OUTPUT_ACTUATORS  INOUT
...
void init_addresses()
{
  ...
  uip_ip6addr(&output_actuators[0], HEXPREFIX, 0, 0, 0, 0x200, 0, 0, 9);
  uip_ip6addr(&output_actuators[1], HEXPREFIX, 0, 0, 0, 0x200, 0, 0, 0xe);
  uip_ip6addr(&output_actuators[2], HEXPREFIX, 0, 0, 0, 0x200, 0, 0, 0xa);
}
#elif INOUT == 4 //3
...
void init_addresses()
{
  ...
  uip_ip6addr(&input_sensors[1], HEXPREFIX, 0, 0, 0, 0x200, 0, 0, 4);
  uip_ip6addr(&input_sensors[2], HEXPREFIX, 0, 0, 0, 0x200, 0, 0, 5);
  uip_ip6addr(&input_sensors[3], HEXPREFIX, 0, 0, 0, 0x200, 0, 0, 15);

  uip_ip6addr(&output_actuators[0], HEXPREFIX, 0, 0, 0, 0x200, 0, 0, 9);
  uip_ip6addr(&output_actuators[1], HEXPREFIX, 0, 0, 0, 0x200, 0, 0, 0xe);
  uip_ip6addr(&output_actuators[2], HEXPREFIX, 0, 0, 0, 0x200, 0, 0, 0xa);
  uip_ip6addr(&output_actuators[3], HEXPREFIX, 0, 0, 0, 0x200, 0, 0, 16);
}
