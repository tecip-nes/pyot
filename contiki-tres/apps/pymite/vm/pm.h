...
/**
 * Executes the named module contained in a specific image
 *
 * @param modstr        Name of module to run
 * @param memspace      Memory space in which the image is located
 * @param imgaddr       Address of the user image in the memory space
 * @return Return status
 */
PmReturn_t pm_run_from_img(uint8_t const *modstr, PmMemSpace_t memspace, 
